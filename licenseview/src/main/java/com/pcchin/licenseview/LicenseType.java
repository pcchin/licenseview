...
public final class LicenseType {
    ...
    // BSD Licenses
    public static final String BSD_0 = "0-clause BSD License";
    ...
    // Misc Licenses
    public static final String APL_1 = "Adaptive Public License 1.0";
    public static final String BOOST_SOFTWARE_1 = "Boost Software License 1.0";
    public static final String FPL_1 = "Zero-Clause BSD / Free Public License 1.0.0";
